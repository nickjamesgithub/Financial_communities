...
# Histogram plots
plt.hist(dotcom_values_array, bins=30, alpha=0.2, label='Dot-com bubble')
plt.hist(gfc_values_array, bins=30, alpha=0.2, label='GFC')
plt.hist(gfc_peak_values_array, bins=30, alpha=0.2, label='GFC Peak')
plt.hist(covid_values_array, bins=30, alpha=0.2, label='COVID')
plt.hist(covid_peak_values_array, bins=30, alpha=0.2, label='COVID Peak')
plt.hist(ukraine_crash_values_array, bins=30, alpha=0.55, label='2022 Crash', color='red')
plt.legend()
