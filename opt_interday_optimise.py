...
plt.plot(money_list_cs_fix)
plt.ylabel("Realised_profit")
plt.xlabel("Days_in_strategy")
plt.savefig("Profit_interday_strategy")
plt.show()
...
#                 money_list_cs_fix, state_list_cs_fix, long_counter_list_, short_counter_list_, \
...
#                 # Append long counter list and short counter list
#                 long_counter_list.append(long_counter_list_)
#                 short_counter_list.append(short_counter_list_)
#     print("iteration", lo)
...
# short_counter_list = []
# money_list_cs_fix, state_list_cs_fix, long_counter_list_, short_counter_list_, \
# long_x_decision, exit_long_x_decision, short_x_decision, exit_short_x_decision = backtest(
#     max_positions=3, long_x_parameter_open=-1, long_x_parameter_close=0, short_x_parameter_open=1, short_x_parameter_close=0)
# results.append([money_list_cs_fix[-1], -1, 0, 1, 0])
#
# # Append long counter list and short counter list
# long_counter_list.append(long_counter_list_)
# short_counter_list.append(short_counter_list_)
...
# Long and Short Strategy Counter List
plt.plot(grid, np.array(long_counter_list).flatten(), label="Long_X_strategy")
plt.plot(grid, np.array(short_counter_list).flatten(), label="Short_X_strategy")
plt.plot(grid, zscore(ratio_xy), color='black')
plt.legend()
